...
class SleepQualityFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val viewModelFactory = SleepQualityViewModelFactory(application, databaseDao,
                args.sleepNightKey )

        val sleepQualityViewModel = ViewModelProviders
                .of(this, viewModelFactory).get(SleepQualityViewModel::class.java)
